...
<div class="content">
  ...
  <div class="box" id="main" style="width: 390px; margin: auto;">
    <div class="contact">
      ...
      Wir selbst sehen uns seit einiger Zeit nicht mehr direkt als Service für Sendungsnotizen, sondern eher als Plattform, auf welcher die Hörer eines Podcasts ihren Podcastern helfen können.<br/>
      Natürlich werden wir bei guten Podcasts auch selbst ab und an mithelfen.<br/> Egal ob guter oder weniger guter Podcast sollte aber trotzdem jeder Podcaster auch bei seinen Hörern für <a href="http://shownot.es/">Shownot.es</a> Werbung machen um einige Hörer zu Shownotern zu rekrutieren.<br/> Bei Fragen bzgl. unserer Technik und zum <a href="http://shownotes.github.io/OSF-in-a-Nutshell/#deutsch">Open Shownote Format</a> helfen wir natürlich gerne weiter.
      </p><br/>
      <form action="http://simon.waldherr.eu/contactShownotes/" id="contactForm" method="post" onsubmit="return getdata();">
        <div class="input-prepend baf-input"><label class="baf grey w120 add-on" for="name" id="label-Name1">Name</label><input class="input-grey" id="name" name="text-Name1" maxlength="" size="16" type="text" value="(Dein Name)" /></div>
        ...
        <div class="input-prepend baf-input"><label class="baf grey w120 add-on" for="subject" id="label-Betreff3">Betreff</label><input class="input-grey" id="subject" name="text-Betreff3" maxlength="" size="16" type="text" value="(Name deines Podcasts)" /></div>
